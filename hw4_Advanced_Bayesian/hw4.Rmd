...
df <- read.csv("https://raw.githubusercontent.com/agricolamz/2019_data_analysis_for_linguists/master/data/students/amikoz/hw4_Advanced_Bayesian/hw4_caretta.csv")
speakers <- data.frame(table(df$speaker))
